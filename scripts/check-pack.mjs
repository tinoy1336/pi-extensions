...
const EXPECTED_FILES = {
	...
	"@tinoy/pi-fleet": ["LICENSE","README.md","fleet/adopt.ts","fleet/board.ts","fleet/index.ts","fleet/items.ts","fleet/launch.ts","fleet/mode.ts","fleet/predicates.ts","fleet/release.ts","fleet/retire.ts","fleet/roster.ts","fleet/section.ts","fleet/status.ts","io-guard/claims.ts","io-guard/identity.ts","io-guard/index.ts","io-guard/locks.ts","io-guard/pend.ts","io-guard/predicates.ts","io-guard/reap.ts","io-guard/versions.ts","package.json"],
