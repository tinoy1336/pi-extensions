// semantic-release configuration for @tinoy/pi-image-read.
//
...
export default {
	branches: ["main"],
	tagFormat: "image-read-v${version}",
	plugins: [
		["@semantic-release/commit-analyzer", { preset: "conventionalcommits" }],
		["@semantic-release/release-notes-generator", { preset: "conventionalcommits" }],
		["@semantic-release/changelog", { changelogFile: "packages/image-read/CHANGELOG.md" }],
		["@semantic-release/npm", { pkgRoot: "packages/image-read" }],
		[
			"@semantic-release/git",
			{
				assets: [
					"packages/image-read/package.json",
					"packages/image-read/CHANGELOG.md",
					"package-lock.json",
				],
				message:
					"chore(release): image-read ${nextRelease.version} [skip ci]\n\n${nextRelease.notes}",
			},
		],
